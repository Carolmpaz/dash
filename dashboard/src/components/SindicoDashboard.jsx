  ...
  return (
    <div className="dashboard-container">
      ...
      <main className="dashboard-main">
        ...
        {activeTab === 'history' && <ConsumptionHistory deviceId={deviceId} userInfo={userInfo} />}
        {activeTab === 'costs' && <CostManagement deviceId={deviceId} userInfo={userInfo} />}
        {activeTab === 'alerts' && <AlertsManagement deviceId={deviceId} userInfo={userInfo} />}
